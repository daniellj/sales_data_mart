...
echo Running: %DBT_EXE% clean --project-dir %DBT_SEEDS_DIR% --profiles-dir %DBT_SEEDS_DIR%
"%DBT_EXE%" clean --project-dir "%DBT_SEEDS_DIR%" --profiles-dir "%DBT_SEEDS_DIR%"
echo -----------------------------------------------------------
REM Executa dbt deps
echo Running: %DBT_EXE% deps --project-dir %DBT_SEEDS_DIR% --profiles-dir %DBT_SEEDS_DIR%
"%DBT_EXE%" deps --project-dir "%DBT_SEEDS_DIR%" --profiles-dir "%DBT_SEEDS_DIR%"
echo -----------------------------------------------------------
REM Executa dbt seed
echo Running seed: %DBT_EXE% seed --project-dir %DBT_SEEDS_DIR% --profiles-dir %DBT_SEEDS_DIR%
"%DBT_EXE%" seed --project-dir "%DBT_SEEDS_DIR%" --profiles-dir "%DBT_SEEDS_DIR%"
echo -----------------------------------------------------------